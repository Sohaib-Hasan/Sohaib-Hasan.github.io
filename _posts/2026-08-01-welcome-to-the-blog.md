...
Since this is a mathematics site, math needs to survive Markdown untouched — so always wrap it in double dollar signs, `$$...$$`, whether it's sitting inside a sentence or on its own line. Jekyll figures out inline vs. display automatically:

Inline, inside a sentence: $$E = mc^2$$ works fine right in the middle of text.

On its own line, it becomes a centered display equation:

$$\int_0^1 x^2 \, dx = \frac{1}{3}$$

(A single dollar sign, `$5`, is never treated as math — so prices and normal text are always safe.)
